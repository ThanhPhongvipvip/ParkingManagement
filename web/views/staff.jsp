                                ...
                                <c:forEach items="${staffList}" var="staff" varStatus="loop">
                                    <tr>
                                        ...
                                        <td style="display: flex; gap: 15px; align-items: center;">
                                            <button class="btn-text btn-edit" style="color: var(--apple-blue); padding: 0;" 
                                            ...
                                            <form action="${pageContext.request.contextPath}/staff" method="POST" style="margin: 0;">
                                                ...
                                                <button type="submit" class="btn-text" style="color: ${staff.isActive ? '#ff9500' : '#34c759'}; padding: 0;" onclick="return confirm('Đổi trạng thái tài khoản này?')">
                                            ...
                                            <form action="${pageContext.request.contextPath}/staff" method="POST" style="margin: 0;">
                                                ...
                                                <input type="hidden" name="staffId" value="${staff.userID}">
                                                <button type="submit" class="btn-text" style="color: #ff3b30; padding: 0;" onclick="return confirm('CẢNH BÁO: Bạn có chắc chắn muốn XÓA VĨNH VIỄN nhân viên này? Hành động này không thể hoàn tác!')">
